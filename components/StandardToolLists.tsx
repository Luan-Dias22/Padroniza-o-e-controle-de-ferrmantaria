                  ...
                  <div className="space-y-3">
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        className="w-full p-2.5 bg-slate-900 border border-slate-700 rounded-xl text-sm text-slate-300 focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 outline-none transition-all appearance-none disabled:opacity-50"
                      >
