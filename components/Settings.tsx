...
export default function Settings({ onSync, onSyncToGuest, onGetBackup, onRestoreBackup, isGuest = false }: { 
  ...
  return (
    ...
    >
      <div className="p-6 border-b border-slate-200/50 dark:border-slate-800/50 bg-white/30 dark:bg-slate-900/30 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
      ...
      <div className="p-6 overflow-y-auto flex-1 custom-scrollbar">
        <div className="max-w-2xl">
          <motion.div 
            ...
            className="bg-slate-100/30 dark:bg-slate-800/30 border border-slate-300/50 dark:border-slate-700/50 rounded-xl p-6 shadow-inner"
          >
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-4 flex items-center gap-2">
              <ImageIcon className="w-5 h-5 text-cyan-400" />
              Logo da Empresa
            </h2>
            <p className="text-slate-400 dark:text-slate-500 dark:text-slate-400 text-sm mb-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              <div className="w-48 h-32 border-2 border-dashed border-slate-300 dark:border-slate-700 rounded-xl flex items-center justify-center bg-white/50 dark:bg-slate-900/50 relative overflow-hidden group transition-colors hover:border-cyan-500/50">
                {logo ? (
                  <>
          ...
          <motion.div 
            ...
            className="bg-slate-100/30 dark:bg-slate-800/30 border border-slate-300/50 dark:border-slate-700/50 rounded-xl p-6 shadow-inner mt-6"
          >
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-4 flex items-center gap-2">
            ...
            <div className="space-y-6">
              <div>
                <p className="text-slate-700 dark:text-slate-300 text-sm font-medium mb-3">Sua Conta Particular</p>
                  ...
                  {!isGuest ? (
                    <button
                      ...
                      className={`
                        ...
                        ${syncStatus === 'loading' ? 'bg-slate-200 dark:bg-slate-700 text-slate-400 dark:text-slate-500 dark:text-slate-400 cursor-not-allowed' : 
                          ...
                          'bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-slate-900 dark:text-white shadow-[0_0_20px_rgba(6,182,212,0.3)]'}
                      `}
                    >
                      {syncStatus === 'loading' ? (
                        <>
              ...
              {!isGuest && (
                <div className="pt-6 border-t border-slate-700/30">
                  <p className="text-slate-700 dark:text-slate-300 text-sm font-medium mb-1 text-cyan-400">Acesso para Convidados</p>
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4">
                    <button
                      ...
                      className={`
                        flex items-center gap-3 px-6 py-3 rounded-xl font-medium transition-all shadow-lg w-full sm:w-auto justify-center
                        ${guestSyncStatus === 'loading' ? 'bg-slate-200 dark:bg-slate-700 text-slate-400 dark:text-slate-500 dark:text-slate-400 cursor-not-allowed' : 
                          ...
                          'bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-slate-200 border border-slate-300 dark:border-slate-700'}
                      `}
                    >
              ...
              {!isGuest ? (
                <>
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-3 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-slate-200 border border-slate-300 dark:border-slate-700 rounded-xl transition-all text-sm font-medium w-full sm:w-auto justify-center"
                  >
                  ...
                  <div className="relative w-full sm:w-auto">
                    ...
                    <button
                      ...
                      className={`
                        ...
                        ${restoreStatus === 'loading' ? 'bg-slate-200 dark:bg-slate-700 text-slate-400 dark:text-slate-500 dark:text-slate-400 cursor-not-allowed' : 
          ...
          <div className="mt-12 pt-6 border-t border-slate-200/50 dark:border-slate-800/50">
            <button 
              ...
              className="text-slate-600 hover:text-slate-400 dark:text-slate-500 dark:text-slate-400 text-xs flex items-center gap-2 transition-colors"
            >
            ...
            <AnimatePresence>
              {showDebug && (
                <motion.div
                  ...
                  className="mt-4 p-4 bg-black/40 rounded-lg border border-slate-200 dark:border-slate-800 font-mono text-[10px] text-slate-400 dark:text-slate-500 overflow-hidden"
                >
